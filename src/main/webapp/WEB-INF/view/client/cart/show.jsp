                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="mb-0 mt-4"><a href="/product/${cartDetail.product.id}"></a>
                                    ${cartDetail.product.name}
                                </p>
                            </td>
                            <td>
                                <p class="mb-0 mt-4"><fmt:formatNumber type="number" 
                                    value="${cartDetail.price} " />đ</p>
                            </td>
                            <td>
                                <div class="input-group quantity mt-4" style="width: 100px;">
                                    ...
                                    data-cart-total-index="${status.index}">
                                    <div class="input-group-btn">
                            ...
                            <td>
                                <p class="mb-0 mt-4" data-cart-total-id="${cartDetail.id}">
